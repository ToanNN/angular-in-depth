      ...
      for (let errorName in this.errors) {
        switch (errorName) {
          ...
          case "pattern":
            ...
            break;
          case 'limit':
            messages.push(`A ${this.label} cannot be more than ${this.errors['limit'].maximumValue}`);
            break;
        }
      }
    }
  ...
  constructor() {
    super({
      ...
      price: new ProductFormControl("Price", "price", "",
        Validators.compose([Validators.required, LimitValidator(100), Validators.pattern("^[0-9\.]+$")]))
    })
  }
